...
Agora is in early prototype development. The current app is a dependency-free browser prototype with seeded workspace data, local persistence, project filters, task creation, comments, activity, employee time tracking, list view, board view, project workspaces, milestones, project timelines, and a My Work view.
