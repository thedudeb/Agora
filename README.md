...
The prototype stores changes in browser local storage. Use the Dashboard setup panel to choose demo data or start with a clean workspace. Use "Reset sample data" in the sidebar to restore the seeded workspace.
