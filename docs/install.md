...
Then edit `.env` with real Supabase, SMTP/webhook, hosted origin, release, and backup values. Run Supabase migrations `001`, `002`, `003`, `004`, and `005`, create the private `agora-files` bucket, and validate:
