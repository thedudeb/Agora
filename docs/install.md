...
Then edit `.env` with real Supabase, SMTP/webhook, hosted origin, release, and backup values. Run Supabase migrations `001`, `002`, `003`, and `004`, create the private `agora-files` bucket, and validate:
