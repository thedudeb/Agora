...
includes("index.html", "./src/app-recovery.js?v=workspace-platform-v1", "loads Data and Recovery route rendering after the app bundle");
includes("index.html", "./src/app-project-board.js?v=workspace-platform-v1", "loads Project and Board route rendering before runtime wiring");
...
includes("sw.js", "./src/app-recovery.js?v=workspace-platform-v1", "caches Data and Recovery route rendering for offline reloads");
includes("sw.js", "./src/app-project-board.js?v=workspace-platform-v1", "caches Project and Board route rendering for offline reloads");
