...
includes("index.html", "./src/app-project-board.js?v=workspace-platform-v2", "loads Project and Board route rendering before runtime wiring");
...
includes("sw.js", "./src/app-project-board.js?v=workspace-platform-v2", "caches Project and Board route rendering for offline reloads");
