const CACHE_VERSION = "agora-pwa-v67";
const APP_SHELL = [
  "./",
  "./index.html",
  "./offline.html",
  ...
  "./src/app.js?v=workspace-platform-v10",
  "./src/app-inbox.js?v=workspace-platform-v1",
  "./src/app-runtime.js?v=workspace-platform-v1"
];
